...
const config: Config = {
  ...
  future: {
    v4: false, // Temporarily disable to fix image path resolution issues
  },
  ...
  baseUrl: process.env.STAGING === 'true' ? '/staging/' : '/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/OpenHD/OpenHD-Website/edit/main/',
