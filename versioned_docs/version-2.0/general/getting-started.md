...
![Raspberry Pi GPIO header pins](/img/assets/v2-0/image%20(24)%20(2)%20(2)%20(1).png)
...
![Raspberry Pi Powered from Pin Header](/img/assets/v2-0/image%20(1).png)
...
![The basic diagram we want to achieve for this step](/img/assets/v2-0/image%20(4)%20(2)%20(9)%20(6).png)
...
![Properly wired Raspberry Pi Zero](/img/assets/v2-0/image%20(8)%20(1)%20(1)%20(1).png)
...
![The Raspberry Pi Zero CSI connector, notice the pins are on the side near the PCB](/img/assets/v2-0/image%20(18)%20(1)%20(1)%20(1).png)

![The Raspberry Pi 3B CSI connector, notice the pins are facing away from the white locking tab](/img/assets/v2-0/image%20(14).png)
...
![The Raspberry Pi V1.3 Camera board connector, notice the pins are on the side of the PCB (white part)](/img/assets/v2-0/image%20(12).png)

So now that we know where the pins are on the boards, let's inspect the CSI **cable** itself.

![The 'pins' are exposed on one side of the CSI cable](/img/assets/v2-0/image%20(17).png)

![And the opposite side is clearly labelled (blue here, can be different on other cables)](/img/assets/v2-0/image%20(13).png)
...
![Pull up the locking tab and insert the cable with the pins facing the connector pins](/img/assets/v2-0/image%20(16).png)
...
![Use equal pressure to lock the tab](/img/assets/v2-0/image%20(9).png)

Make sure the cable is **properly seated** before continuing.

![A properly seated CSI cable](/img/assets/v2-0/image%20(15).png)
